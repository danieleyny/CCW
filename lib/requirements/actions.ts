...
export const REQUIREMENT_ACTIONS: Record<string, RequirementAction> = {
  ...
  "REL-01": {
    conciergeScope: "full",
    mode: "obtain",
    actionLabel: "Add your signed releases",
    documentType: "notarized_release",
    sourceUrl: "https://licensing.nypdonline.org/",
    steps: [
      "Download both release forms below — the employment records release and the HIPAA medical release. These are the two the License Division's investigation reaches into.",
      "Sign each one (the employment form on the Applicant's Signature line; the HIPAA form as the patient). Neither needs a notary — a plain signature is enough.",
      "Bring the signed originals to your interview — these are held with your file, not uploaded to the portal.",
      "Upload a copy of each here so we have them on record.",
    ],
    customerTitle: "Your release authorizations",
    help: "The application asks you to provide signed releases so the License Division can obtain records relevant to its review — an employment records release and a HIPAA medical release. We hand you both forms filled with what we can; you sign them and bring the originals to your interview. If a notary attaches a certificate that's fine, but neither form requires notarization.",
  },
  "COR-01": {
    conciergeScope: "full",
    mode: "obtain",
