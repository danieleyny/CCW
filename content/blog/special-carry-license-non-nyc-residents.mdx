...
**How the application gets filed depends on your plan — and distance doesn't change that.** On Self-Guided you file it yourself; with Full Concierge, Gun License NYC files it with the NYPD on your behalf. Either way, **only a New York-licensed attorney may represent an applicant before the License Division** ([NYPD License Division](https://www.nyc.gov/site/nypd/services/law-enforcement/pistol-license.page)) — a service prepares and files, it does not represent you. What good preparation does is make sure that when *you* file, the package is complete and the in-person steps are sequenced so you're not making the trip twice.
